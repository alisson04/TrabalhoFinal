 ...
 * @author Andre
 */
public class CadastroGerenteForm extends javax.swing.JInternalFrame {

    /**
     * Creates new form CadastroGerenteForm
     */
    public CadastroGerenteForm() {
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(null, "Cadastro de Gerente", javax.swing.border.TitledBorder.DEFAULT_JUSTIFICATION, javax.swing.border.TitledBorder.DEFAULT_POSITION, new java.awt.Font("Times New Roman", 1, 18))); // NOI18N
    ...
    private void btnCadastrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnCadastrarActionPerformed
        ...
        if (!nome.isEmpty() && !email.isEmpty() && !senha.isEmpty()) {
            try {
                ...
                if(usuarioBO.validarGerente(usuario)){
